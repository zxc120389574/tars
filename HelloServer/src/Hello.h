...
namespace TestApp
{
    ...
    public:
        ...
        virtual void callback_testHello(tars::Int32 ret,  const std::string& sRsq)
        ...
        virtual int onDispatch(tars::ReqMessagePtr msg)
        {
            ...
            switch(r.first - __Hello_all)
            {
                ...
                case 1:
                {
                    ...
                    std::string sRsq;
                    _is.read(sRsq, 2, true);
                    CallbackThreadData * pCbtd = CallbackThreadData::getData();
                    assert(pCbtd != NULL);

                    pCbtd->setResponseContext(msg->response->context);

                    callback_testHello(_ret, sRsq);
    ...
    public:
        ...
        tars::Int32 testHello(const std::string & sReq,std::string &sRsq,const map<string, string> &context = TARS_CONTEXT(),map<string, string> * pResponseContext = NULL)
        {
            tars::TarsOutputStream<tars::BufferWriterVector> _os;
            _os.write(sReq, 1);
            _os.write(sRsq, 2);
    ...
    public:
        ...
        virtual tars::Int32 testHello(const std::string & sReq,std::string &sRsq,tars::TarsCurrentPtr current) = 0;
        static void async_response_testHello(tars::TarsCurrentPtr current, tars::Int32 _ret, const std::string &sRsq)
        {
            if (current->getRequestVersion() == TUPVERSION )
            {
                UniAttribute<tars::BufferWriterVector, tars::BufferReader>  tarsAttr;
            ...
            {
                tars::JsonValueObjPtr _p = new tars::JsonValueObj();
                _p->value["sRsq"] = tars::JsonOutput::writeJson(sRsq);
                _p->value["tars_ret"] = tars::JsonOutput::writeJson(_ret);
                vector<char> sJsonResponseBuffer;
                tars::TC_Json::writeValue(_p, sJsonResponseBuffer);
                current->sendResponse(tars::TARSSERVERSUCCESS, sJsonResponseBuffer);
            ...
            switch(r.first - __TestApp__Hello_all)
            {
                ...
                case 1:
                {
                    ...
                    if (_current->getRequestVersion() == TUPVERSION)
                    {
                        ...
                        tarsAttr.getByDefault("sRsq", sRsq, sRsq);
                    }
                    else if (_current->getRequestVersion() == JSONVERSION)
                    {
                        tars::JsonValueObjPtr _jsonPtr = tars::JsonValueObjPtr::dynamicCast(tars::TC_Json::getValue(_current->getRequestBuffer()));
                        tars::JsonInput::readJson(sReq, _jsonPtr->value["sReq"], true);
                        tars::JsonInput::readJson(sRsq, _jsonPtr->value["sRsq"], false);
                    }
                    else
                    {
                        _is.read(sReq, 1, true);
                        _is.read(sRsq, 2, false);
                    }
                    tars::Int32 _ret = testHello(sReq,sRsq, _current);
                    if(_current->isResponse())
                    {
                        if (_current->getRequestVersion() == TUPVERSION)
                        {
